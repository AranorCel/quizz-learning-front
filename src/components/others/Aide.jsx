        ...
        <>
            ...
            <section>
                ...
                <ul>
                    ...
                    <p>En tant que formateur, vous avez la possiblité de créer des leçons et des quizz en quelques minutes. Pour cela, cliquez sur les liens en haut à gauche respectivement <NavLink to="/lessons">LEÇONS</NavLink> et <NavLink to="/quizz">QUIZZ</NavLink>. Une fois, dans la catégorie de votre choix, votre statut de formateur vous permet d'accéder aux formulaires de création de leçon ou de quizz.</p>
                    ...
                    <ul>
                        <li>soit dans l'onglet spécifique des <NavLink to="/lessons">LEÇONS</NavLink>,</li>
                    ...
                    <ul>
                        <li>soit dans l'onglet spécifique des <NavLink to="/quizz">QUIZZ</NavLink>,</li>
